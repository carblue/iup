...
extern (C) int multitext_caret_cb (Ihandle *ih, int lin, int col, int pos) nothrow
{
...
int main(string[] args) { // C: int main(int argc, char **argv)
  ...
  IupSetCallback(multitext, "CARET_CB", cast(Icallback)&multitext_caret_cb);
