 ...
 * \ingroup stats */
c_ulong imCalcCountColors(const(imImage)* image);
 ...
 * \ingroup stats */
void imCalcGrayHistogram(const(imImage)* image, c_ulong* histo, int cumulative);
 ...
 * \ingroup stats */
void imCalcHistogram(const(imImage)* image, c_ulong* histo, int plane, int cumulative);
 ...
 * \ingroup stats */
void imCalcByteHistogram(const(ubyte)* data, int count, c_ulong* histo, int cumulative);
 ...
 * Not available in Lua.
 * \ingroup stats */
void imCalcUShortHistogram(const(ushort)* data, int count, c_ulong* histo, int cumulative);
 ...
 * Not available in Lua.
 * \ingroup stats */
void imCalcShortHistogram(const(short)* data, int count, c_ulong* histo, int cumulative);

/** Alocates an histogram data based on the image data type. \n
 * Data type can be IM_BYTE, IM_SHORT or IM_USHORT. \n
 * Not available in Lua.
 * \ingroup stats */
c_ulong* imHistogramNew(int data_type, int* hcount);

/** Releases the histogram data. \n
 * Not available in Lua.
 * \ingroup stats */
void imHistogramRelease(c_ulong* histo);
 ...
 * \ingroup stats */
struct imStats // typedef struct _imStats imStats
{
  float max;                /**< Maximum value              */
  float min;                /**< Minimum value              */
  c_ulong positive;   /**< Number of Positive Values  */
  c_ulong negative;   /**< Number of Negative Values  */
  c_ulong zeros;      /**< Number of Zeros            */
  float mean;               /**< Mean                       */
