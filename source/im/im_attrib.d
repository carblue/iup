...
public:
  ...
  ~this()
    { imAttribTableDestroy(ptable); ptable = null; }
   ...
   * See also \ref imDataType. */
  const(void)* Get(const(char)* name, int* data_type = null, int* count = null) const
...
public:
   ...
   * Returns the attribute if found, NULL otherwise.
   * See also \ref imDataType. */
  const(void)* Get(int index, char* name = null, int* data_type = null, int* count = null) const
